...
?>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                ...
                                <form action="https://sgexplore.tk/main/search.php" method="POST">
									<input type="search" name="search" id="search" placeholder="Search Your Desire Attractions" class="form-control">
                                    <button type="submit" value="submit" class="btn dorne-btn"><i class="fa fa-search pr-2" aria-hidden="true"></i> Search</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="about-content text-center">
                        ...
                        <p>SGexplore aims to provide a all in one Singapore attractions so that tourist can easily create an itinerary and view it on their phone easily.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="dorne-editors-pick-area bg-img bg-overlay-9 section-padding-100 bg-default">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="widget">
						...
						<div class="fb-page" data-href="https://www.facebook.com/STBsingapore/" data-tabs="timeline" data-width="500" data-height="400" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false">
							<blockquote cite="https://www.facebook.com/STBsingapore/" class="fb-xfbml-parse-ignore">
								<a href="https://www.facebook.com/STBsingapore/">Singapore Tourism Board</a>
							</blockquote>
						</div>
					</div>
                </div>
                <div class="col-12 col-lg-6">
                    <a class="twitter-timeline" data-width="500" data-height="400" data-theme="light" href="https://twitter.com/stb_sg?ref_src=twsrc%5Etfw">Tweets by stb_sg</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                </div>
            </div>
        </div>
    </section>
