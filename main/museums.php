            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading dark text-center">
                        <span></span>
                        <h4>Museums</h4>
                        <p>Explore Museums of Singapore</p>
                    </div>
                </div>
            </div>
            <div class="row">';
    ...
    if ($result != NULL) {
        ...
        if ($count == 0){
            ...
            while ($row= $result->fetch_assoc()) {
				echo '<a href="museums.php/'.$row["id"].'"><div class="col-12 col-sm-6 col-lg-4">
						<div class="single-features-area mb-50">
							...
							<div class="feature-content d-flex align-items-center justify-content-between">
								...
								<div class="feature-favourite">
									<a href="museums.php/'.$row["id"].'"><i class="fa fa-plus-o" aria-hidden="true"></i></a>
								</div>
							</div>
						</div>
					</div></a>';
...
$app->post('/',function() use ($app){
	...
	$museums = new museums();
    $result = $museums->distance($long,$lat,$distance);
     if ($result != NULL) {
        $response["error"] = false;
        $count = $result->num_rows;
        if ($count == 0){
